...
// Available at https://github.com/courtier/discordgo
...
// disconnect the websocket connection after a few seconds. First heartbeat
// should be sent after heartbeatInterval * random ms.
